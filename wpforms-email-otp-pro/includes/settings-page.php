...
add_action('admin_init', function() {
    ...
    add_settings_field('form_id', __('WPForms Form ID', 'wpforms-email-otp-pro'), function() {
        $options = get_option('wpforms_email_otp_pro_settings');
        echo '<input type="number" name="wpforms_email_otp_pro_settings[form_id]" value="' . esc_attr($options['form_id'] ?? '') . '" class="regular-text">';
    }, 'wpforms-email-otp-pro', 'wpforms_email_otp_pro_main');

    add_settings_field('email_label', __('Email Field Label', 'wpforms-email-otp-pro'), function() {
        $options = get_option('wpforms_email_otp_pro_settings');
